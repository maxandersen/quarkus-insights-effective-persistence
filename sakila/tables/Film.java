...
public class Film extends TableImpl<FilmRecord> {
     ...
     */
    public final TableField<FilmRecord, Integer> RELEASE_YEAR = createField(DSL.name("release_year"), sakila.Domains.YEAR.getDataType(), this, "");
     ...
     */
    public final TableField<FilmRecord, MpaaRating> RATING = createField(DSL.name("rating"), SQLDataType.VARCHAR.defaultValue(DSL.field("'G'::mpaa_rating", SQLDataType.VARCHAR)).asEnumDataType(sakila.enums.MpaaRating.class), this, "");
